...
class getPulseApp(object):
    ...
    def main_loop(self):
        ...
        if faRect[2] > 2:
            ...
            cv2.putText(self.processor.frame_out, "Left Cheek", (lcRect[0], lcRect[1]-5), 
                                        cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 0))
            self.processor.draw_rect(lcRect)
            self.processor.displayColorInfo( self.processor.get_subface_means(lcRect),
                                                            [335,360,385], "left cheek" )
            cv2.putText(self.processor.frame_out, "Right Cheek", (rcRect[0], rcRect[1]-5), 
                                        cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 0))
            self.processor.draw_rect(rcRect)
            self.processor.displayColorInfo( self.processor.get_subface_means(fhRect),
                                                            [410,435,460], "right cheek" )
...
if __name__ == "__main__":
    ...
    cap = cv2.VideoCapture('testdata/test1.mp4')
